    ...
    return (
        <div className="w-full max-w-sm bg-[#393939] rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div className="px-5 pb-5 bg-black">
                <a href="#">
                    <h5 className="text-xl font-semibold tracking-tight text-white dark:text-white">Apple Watch Series 7 GPS, Aluminium Case, Starlight Sport</h5>
                </a>
                <div className="flex items-center mt-2.5 mb-5">
                    <div className="flex items-center space-x-1 rtl:space-x-reverse">
                        <svg className="w-4 h-4 text-[#12daa8]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
              ...
              <delete className='font-semibold text-m line-through text-white ml-[16px]'>₹99999</delete>
                    </div>
                    <div className='flex text-[white] py-[23px]'>
                        <CiDeliveryTruck className='text-[26px] gap-3 mr-[5px] '/>
                        <span className='text-[15px] py-[4px]'>Standard Delivery by Tomorrow</span>
                </div>
            </div>
        </div>
    );
